...
if (isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO students (username,email,subject,sms) VALUES ('$name', '$email', '$subject','$message')";
    if (mysqli_query($conn, $sql))
    {

        $sendsms ="New record created successfully";
    }
}
?>
<?php if(isset($sendsms)){
  if($sendsms){
  header('Location:welcome.php ' . $_SESSION['PHP_SELF']);

} 
 echo "<span style='margin-left:20px; padding:10px; color:green;'>";
 echo $sendsms;
 echo "</span>";
}
  ?> 
...
<head>
  <meta charset="utf-8">
  <title>Imran Web Designer</title>
  ...
  <link href="lib/ionicons/css/ionicons.min.css" rel="stylesheet">
   <link href="lib/ionicons/css/boxicons.min.css" rel="stylesheet">
...
<header id="header">
      ...
      <a href="#header" class="scrollto"><img src="img/my1.png" alt="" class="img-fluid"></a> 
      </div>
...
<section id="intro" class="clearfix">
      ...
      <img src="img/back.jpg" class="container-personal">
      <h2>Hello</span></h2>
      <h1 class="text-type">
      <a href="" class="typewrite" data-period="2000" data-type='[  "I am Freelancer Imran", "I am Creative Web Designer", "I am Web Developer" ]'>
      <span class="wrap"></span>
      </a>
      </h1>
      <div>
      <p id="container-button"><a href="#about" class="btn-get-started scrollto">download cv</a></p>
      
<section id="section10" class="demo">
      <a href="#about" class="scrollto"><span></span></a></section>
      </div>
      </div>
...
<section id="about">
      ...
      <ul>
      <li>Email ID : freelancerimran9@gmail.com</li>
      <li>Address  : Tangail Old Bus Stand.</li>
      <li> Birthday  : 05-03-1998.</li>
      <li>Phone    : 01784697461</li>
      </ul>
      </div>
      </div>
      </div>
  ...
  <div class="row">
      ...
      <div class="col-lg-4 col-md-6">
      <!-- Single Service -->
      <div class="single-service"><i class="fa fa-mobile"></i>
...
<section id="container-ED" style="background-color: #f8f9fa !important"> 
      <div id="education" class="container-fluid"> <!-- #Education -->
      <header class="section-header">
...
<section id="skills" class="container-fluid content-section text-center"> <!--skills--> 
      <div class="container-fluid">
      <header class="section-header">
      <h3>My skills</h3>
      </header>
      ...
      <img src="img/back.jpg" alt="" class="img-fluid">
      </div>
      </div>
      <div class="col-lg-6">
...
<section id="why-us" class="wow fadeIn"> <!--project--> 
      <div class="container">
...
<section id="call-to-action" class="wow fadeInUp"><!--Call To Action Section-->
      <div class="container">
      <div class="row">
      <div class="col-lg-12 ">
      <h3 class="cta-title">I Am Available For Freelancer Project.</h3>
      <p class="cta-text"></p>
      <p class="container-text"><a class="cta-btn"href="https://bit.ly/33qROiz">HIRE ME</a></p> 
      </div> 
      </div>
      </div>
</section><!-- #call-to-action -->

<section id="portfolio" class="portfolio section-bg"> <!-- Our Portfolio -->
      <div class="container">
      <header class="section-header">
      <h3>Our Portfolio</h3>
      </header>
      ...
      <a href="img/portfolio/web1.png" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="bx bx-plus"></i></a>
      ...
      <div class="portfolio-links">
      <a href="img/portfolio/b1.png" data-gall="portfolioGallery" class="venobox" title="Web 3"><i class="bx bx-plus"></i></a>
      <a href="#" title="More Details"><i class="bx bx-link"></i></a>
      </div>
      </div>
      </div>
      ...
      <div class="portfolio-links">
      <a href="img/portfolio/web3.png" data-gall="portfolioGallery" class="venobox" title="App 2"><i class="bx bx-plus"></i></a>
      <a href="#" title="More Details"><i class="bx bx-link"></i></a>
      </div>
      </div>
      </div>
      ...
      <div class="portfolio-wrap">
      <img src="img/portfolio/w3.png" class="img-fluid" alt="">
      <div class="portfolio-info">
      <h4>Codeing</h4> 
      </div>
      <div class="portfolio-links">
      <a href="img/portfolio/w3.png" data-gall="portfolioGallery" class="venobox" title="Card 2"><i class="bx bx-plus"></i></a>
      <a href="#" title="More Details"><i class="bx bx-link"></i></a>
      </div>
      </div>
      </div>
      ...
      <div class="portfolio-links">
      <a href="img/portfolio/g.jpg" data-gall="portfolioGallery" class="venobox" title="Web 2"><i class="bx bx-plus"></i></a>
      <a href="#" title="More Details"><i class="bx bx-link"></i></a>
      </div>
      </div>
      </div>
      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
      <div class="portfolio-wrap">
      <img src="img/portfolio/web4.png" class="img-fluid" alt="">
      <div class="portfolio-info"><h4>Web Design</h4></div>
      <div class="portfolio-links">
      <a href="img/portfolio/web4.png" data-gall="portfolioGallery" class="venobox" title="App 3"><i class="bx bx-plus"></i></a>
      <a href="#" title="More Details"><i class="bx bx-link"></i></a>
      </div>
      </div>
      </div>
      ...
      <div class="portfolio-info"><h4>Codeing</h4></div>
      <div class="portfolio-links">
      <a href="img/portfolio/w1.jpg" data-gall="portfolioGallery" class="venobox" title="Card 1"><i class="bx bx-plus"></i></a>
      <a href="#" title="More Details"><i class="bx bx-link"></i></a></div></div>
      </div>
      <div class="col-lg-4 col-md-6 portfolio-item filter-card">
      <div class="portfolio-wrap">
      <img src="img/portfolio/w2.png" class="img-fluid" alt="">
      <div class="portfolio-info"><h4>Codeing</h4></div>
      <div class="portfolio-links">
      <a href="img/portfolio/w2.png" data-gall="portfolioGallery" class="venobox" title="Card 3"><i class="bx bx-plus"></i></a>
      <a href="#" title="More Details"><i class="bx bx-link"></i></a></div></div>
      </div>
      <div class="col-lg-4 col-md-6 portfolio-item filter-Graphics">
      <div class="portfolio-wrap">
      <img src="img/portfolio/portfolio-8.jpg" class="img-fluid" alt="">
      <div class="portfolio-info"><h4>Studio</h4></div>
      <div class="portfolio-links">
      <a href="img/portfolio/portfolio-8.jpg" data-gall="portfolioGallery" class="venobox" title="Web 3"><i class="bx bx-plus"></i></a>
      <a href="#" title="More Details"><i class="bx bx-link"></i></a></div></div>
      </div>
      </div>
      </div>
...
<section id="testimonials"> <!--Clients Section-->
      ...
      <div class="img-box"><img src="img/team/team1.jpg" alt=""></div>
      <p class="testimonial">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at, </p>
      <p class="overview"><b>Nazmul Hasan</b>, CEO</p></div>
      <div class="item carousel-item">
      <div class="img-box"><img src="img/team/team2.jpg" alt=""></div>
      <p class="testimonial">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at,</p>
      <p class="overview"><b>Imran Mahmud</b>, WebDesigner</p>
      </div>
      <div class="item carousel-item">
      <div class="img-box"><img src="img/team/team4.jpg"alt=""></div>
      <p class="testimonial">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu sem tempor, varius quam at,</p>
      <p class="overview"><b>Salman Dewan</b>, WebDesigner</p>
      </div>
      </div>
        <!-- Carousel controls -->
...
<section id="team" class="section-bg"> <!--Team Section-->
    <div class="container">
    ...
    <div class="socials mt-20"><a href="#"><i class="fa fa-facebook"></i></a>
                               ...
                               </div></div><!-- end team member -->

    <div class="col-md-3 col-sm-3 team-wrap">
    <div class="team-member text-center">
    <div class="team-img"><img src="img/team/team2.jpg" alt="">
    <div class="overlay-team">
    <div class="team-details text-center">
    <div class="socials mt-20"><a href="#"><i class="fa fa-facebook"></i></a>
                               <a href="#"><i class="fa fa-twitter"></i></a>
    ...
    <div class="team-img"><img src="img/team/team4.jpg" alt="">
    <div class="overlay-team">
    <div class="team-details text-center">
    <div class="socials mt-20"><a href="#"><i class="fa fa-facebook"></i></a>
                               <a href="#"><i class="fa fa-twitter"></i></a>
    ...
    <div class="col-md-3 col-sm-3 team-wrap">
    <div class="team-member last text-center">
    <div class="team-img"><img src="img/team/team3.jpg" alt="">
    <div class="overlay-team">
    <div class="team-details text-center">
    <div class="socials mt-20"><a href="#"><i class="fa fa-facebook"></i></a>
                               <a href="#"><i class="fa fa-twitter"></i></a>
...
<section id="blog" class="more-services section-bg"> <!-- More Services Section-->
    <div class="container">
    <div class="section-header">
    <h3>our blog</h3>
    ...
    <div class="card">
    <img src="img/blog1.png" class="card-img-top" alt="...">
    <div class="card-body">
    ...
    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mb-5 mb-lg-0">
    <div class="card">
    <img src="img/blog4.png" class="card-img-top" alt="...">
    <div class="card-body">
    ...
    <div class="row">
    <div  class="col-lg-12">   <a href="#" class="rm">Read More <i class="fas fa-angle-right"></i></a></div></div></div></div></div></div>
    </div>
    ...
    <div class="section_code py-3"></div></div></div></div></div></div>
</section>
...
<footer id="footer" class="section-bg">
    ...
    <div class="container">
    <div class="row">
    <div class="col-lg-4 info d-flex flex-column align-items-stretch"><i class="bx bx-map"></i>
    <h4>Address</h4>
    ...
    <div class="col-lg-4 info info-bg d-flex flex-column align-items-stretch"><i class="bx bx-envelope"></i>
    <h4>Email Us</h4>
  ...
  <div class="copyright">&copy; Copyright <strong> ©2020</strong>.Freelancer Imran All Rights Reserved</div></div>
  </footer><!-- #footer -->
